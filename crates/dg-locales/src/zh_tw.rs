...
pub fn translate(key: &'static str) -> &'static str {
    match key {
        ...
        NOTE_EDIT => "編輯內容...",
        NOTE_EDIT_PROMPT => "編輯便箋 (待辦清單每行一條)",
        NOTE_SWITCH_TO_TODO => "切換為待辦清單",
        NOTE_SWITCH_TO_TEXT => "切換為純文字",
        NOTE_TODO_EDIT_HINT => "(右鍵 → 編輯內容 新增項目)",
        NOTE_EMPTY_HINT => "(右鍵 → 編輯內容)",
